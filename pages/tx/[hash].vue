      ...
      <div v-if="metadata">
        ...
        <div class="px-7.5 py-6.5 flex gap-6.5 flex-col">
          ...
          <div v-if="isBridge" class="flex items-center">
            ...
            <div v-if="bridgeStatusPending && !bridgeStatus" class="rounded-5 w-24 h-4 loading-box" />
            <a v-else-if="bridgeStatus" class="flex items-center" :href="`https://socketscan.io/tx/${transaction.hash}`"
              target="_blank">
