            ...
            <div class="flex items-center space-x-4">
              <ClientOnly>
                <div class="flex align-self-end items-center" v-if="networkPreference.size > 0">
                  <ChainLogo v-for="network in Array.from(networkPreference).slice(0, 3)"
                    style="width: 22px; height: 22px" class="-ml-2 first:ml-0" stroke :chain="network" />
                  <div v-if="networkPreference.size > 3" style="width: 22px; height: 22px"
              ...
              <Popover as="div" class="relative z-20 flex gap-4 items-center">
                ...
                <transition enter-active-class="transition duration-100 ease-out"
                  ...
                  <PopoverPanel as="ul"
                    ...
                    <li class="flex items-center justify-between gap-2.5 text-sm py-1 px-3 rounded-[14px]">
                    ...
                    <li
                      ...
                      {{ network.name }}
                      <CheckCircle v-if="networkPreference.has(network.chainId)"
                        class="success-circle cursor-pointer w-5 ml-auto" />
                      <CheckCircle v-else class="svg-circle darker cursor-pointer w-5 ml-auto" />
                    </li>
                  </PopoverPanel>
                </transition>
              </Popover>
