  ...
  <div>
    <div
      :class="[
        ...
        transparent
          ? 'bg-transparent'
          : 'bg-slate-100  focus-within:bg-slate-50 focus-within:ring-1 focus-within:ring-slate-100 dark:bg-gray-900 dark:focus-within:bg-gray-850 dark:focus-within:ring-slate-750',
      ]"
