<template>
  <svg v-if="chain == '137'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    <rect width="22" height="22" x="1" y="1" :fill="generateID('polygon', true)" rx="11" />
    <path fill="#fff"
  ...
  <svg v-else-if="chain == '250'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    <rect width="22" height="22" x="1" y="1" :fill="generateID('fantom', true)" rx="11" />
    <path fill="#fff" fill-rule="evenodd"
    ...
    <rect v-if="stroke" :class="strokeClass" width="22" height="22" x="1" y="1" rx="11" />
    <defs>
      <linearGradient :id="generateID('fantom')" x1="12" x2="12" y1="2" y2="22" gradientUnits="userSpaceOnUse">
...
const generateID = (prefix, wrapURL) => {
