...
const { handleSubmit, meta } = useForm({
  validationSchema: yup.object({
    ...
    confirmAddress: yup
      .string()
      .required()
      .oneOf([yup.ref('address')], 'Addresses must match'),
...
const { value: confirmAddress, errorMessage: confirmErrorMessage } = useField<string>('confirmAddress')
  ...
  <div class="p-7.5">
    ...
    <form class="flex flex-col gap-5" @submit="onSubmit">
      ...
      <div class="flex flex-col gap-2.5">
        ...
        <CommonInput v-model="confirmAddress" :error-message="confirmErrorMessage" placeholder="Signer address" name="confirm-address" />
      </div>
