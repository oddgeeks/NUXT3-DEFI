...
<template>
  ...
  <button
    ...
    class="w-full bg-slate-800 text-white rounded-[30px] inline-flex items-center justify-between px-4 py-1.5 gap-3.5"
  >
    ...
    <span class="flex items-center justify-between gap-3.5 font-semibold">
      <div
        class="flex flex-row items-center gap-2.5 py-1.5 px-3 bg-slate-600 rounded-[30px] leading-5"
      >
        {{ shortenHash(account) }}
      </div>
