...
<template>
  <div
    class="w-full max-w-[832px] mx-auto text-xs relative bg-[#EC974F] bg-opacity-70 py-[15px] px-5 rounded-5 backdrop-blur shrink-0 flex justify-between items-center gap-[15px]"
  >
