...
<template>
  <ClientOnly>
    <Transition name="slide-fade">
      <div v-if="isMultisigOnboardBannerVisible" class="fixed bottom-[50px] left-1/2 z-10 flex w-full -translate-x-1/2 items-center gap-[15px] rounded-5 bg-primary/10 px-5 py-4 pr-7.5 backdrop-blur sm:max-w-[500px]">
        <SvgoGear />
