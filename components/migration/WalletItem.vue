...
<template>
  <button
    class="dark:bg-gray-850 bg-slate-150 dark:border-slate-800 border-slate-50px-4 w-full text-left items-stretch flex justify-between p-5 border rounded-2xl border-slate-150 dark:border-slate-750"
    @click="emit('select')"
  >
    <div>
