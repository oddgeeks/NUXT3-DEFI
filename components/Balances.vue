  ...
  <div class="relative flex-1">
    <div class="h-full w-full flex flex-col gap-5">
      ...
      <div v-else class="w-full">
        <div class="overflow-y-auto overflow-x-auto dark:bg-gray-850 bg-slate-50 rounded-[25px] md:overflow-x-hidden max-h-[600px] hidden sm:flex scroll-style flex-col items-center py-8 lg:py-[100px] gap-[30px]">
