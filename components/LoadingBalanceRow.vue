<template>
  <tr>
    ...
    <td class="py-6">
      <div class="bg-slate-800 rounded-5 w-[120px] h-5"></div>
    </td>
    <td class="px-10 py-6">
      <div class="bg-slate-800 rounded-[20px] w-20 h-5"></div>
    </td>
    <td class="py-6">
      <div class="bg-slate-800 rounded-5 w-[60px] h-5"></div>
    </td>
    <td class="px-7.5 py-6 flex items-center gap-4">
      <div class="bg-slate-800 rounded-5 w-[90px] h-9"></div>
      <div class="bg-slate-800 rounded-5 w-9 h-9"></div>
    </td>
  </tr>
</template>
