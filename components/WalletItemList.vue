  ...
  <div class="flex flex-col">
    ...
    <template v-if="!safesLoading">
      <div class="flex flex-col gap-2.5">
        <WalletItem v-if="legacySafeAddress && legacySafe" tooltip="Please migrate your funds to Avocado Personal to enjoy exciting updates in the future. Your legacy wallet will stay functional & secure forever." :safe="legacySafe" />
