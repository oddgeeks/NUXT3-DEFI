...
export interface AvoSafeImplementationInterface extends utils.Interface {
  functions: {
...
export interface AvoSafeImplementation extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AvoSafeImplementationInterface;
