...
import type {
  AvoMultisigSafe,
  AvoMultisigSafeInterface,
} from "../AvoMultisigSafe";
...
export class AvoMultisigSafe__factory {
  static readonly abi = _abi;
  static createInterface(): AvoMultisigSafeInterface {
    return new utils.Interface(_abi) as AvoMultisigSafeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AvoMultisigSafe {
    return new Contract(address, _abi, signerOrProvider) as AvoMultisigSafe;
  }
}
